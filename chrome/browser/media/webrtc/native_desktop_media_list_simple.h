...
// native windows.
class NativeDesktopMediaListSimple : public DesktopMediaListBase {
 public:
  NativeDesktopMediaListSimple(content::DesktopMediaID::Type type,
                         std::unique_ptr<webrtc::DesktopCapturer> capturer);
  ~NativeDesktopMediaListSimple() override;
...
#endif
  base::WeakPtrFactory<NativeDesktopMediaListSimple> weak_factory_;
