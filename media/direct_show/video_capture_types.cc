...
DirectShowVideoCaptureFormat::DirectShowVideoCaptureFormat()
    : frame_rate(0.0f),
      pixel_format(PIXEL_FORMAT_UNKNOWN),
      pixel_storage(PIXEL_STORAGE_CPU) {}

DirectShowVideoCaptureFormat::DirectShowVideoCaptureFormat(const gfx::Size& frame_size,
                                       float frame_rate,
...
bool DirectShowVideoCaptureFormat::IsValid() const {
...
size_t DirectShowVideoCaptureFormat::ImageAllocationSize() const {
  return VideoFrame::AllocationSize(pixel_format, frame_size);
}

// static
std::string DirectShowVideoCaptureFormat::ToString(const DirectShowVideoCaptureFormat& format) {
  // Beware: This string is parsed by manager.js:parseDirectShowVideoCaptureFormat_,
...
// static
std::string DirectShowVideoCaptureFormat::PixelStorageToString(
...
// static
bool DirectShowVideoCaptureFormat::ComparePixelFormatPreference(
