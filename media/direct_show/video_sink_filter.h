...
#ifndef MEDIA_DIRECT_SHOW_VIDEO_SINK_FILTER_H_
#define MEDIA_DIRECT_SHOW_VIDEO_SINK_FILTER_H_
...
class VideoSinkInputPin;

class __declspec(uuid("88cdbbdc-a73b-4afa-acbf-15d5e2ce1238")) VideoSinkFilter
    : public DirectShowFilterBase {
 public:
  explicit VideoSinkFilter(VideoSinkFilterObserver* observer);
 ...
 private:
  ...
  scoped_refptr<VideoSinkInputPin> input_pin_;
...
#endif  // MEDIA_DIRECT_SHOW_VIDEO_SINK_FILTER_H_
