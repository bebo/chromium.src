...
#ifndef MEDIA_DIRECT_SHOW_VIDEO_CAPTURE_TYPES_H_
#define MEDIA_DIRECT_SHOW_VIDEO_CAPTURE_TYPES_H_
...
//struct CAPTURE_EXPORT DirectShowVideoCaptureFormat {
struct DirectShowVideoCaptureFormat {
  DirectShowVideoCaptureFormat();
  DirectShowVideoCaptureFormat(const gfx::Size& frame_size,
                     float frame_rate,
  ...
  static std::string ToString(const DirectShowVideoCaptureFormat& format);
  ...
  // DirectShowVideoCaptureFormat with no padding and tightly packed.
  ...
  bool operator==(const DirectShowVideoCaptureFormat& other) const {
...
typedef std::vector<DirectShowVideoCaptureFormat> DirectShowVideoCaptureFormats;
...
struct VideoCaptureParams {
  ...
  DirectShowVideoCaptureFormat requested_format;
...
#endif  // MEDIA_DIRECT_SHOW_VIDEO_CAPTURE_TYPES_H_
